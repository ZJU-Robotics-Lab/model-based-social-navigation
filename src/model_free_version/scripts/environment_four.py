...
goal_model_1_dir = os.path.join(os.path.split(os.path.realpath(__file__))[0], '..', '..', 'model_free_version', 'worlds', 'Target_1', 'model.sdf')
goal_model_2_dir = os.path.join(os.path.split(os.path.realpath(__file__))[0], '..', '..', 'model_free_version', 'worlds', 'Target_2', 'model.sdf')
goal_model_3_dir = os.path.join(os.path.split(os.path.realpath(__file__))[0], '..', '..', 'model_free_version', 'worlds', 'Target_3', 'model.sdf')
goal_model_4_dir = os.path.join(os.path.split(os.path.realpath(__file__))[0], '..', '..', 'model_free_version', 'worlds', 'Target_4', 'model.sdf')
...
class Env():
    ...
    def step(self, action):
        ...
        self.agent_2.set_action([action[2], action[3]])
        self.agent_3.set_action([action[4], action[5]])
        self.agent_4.set_action([action[6], action[7]])
